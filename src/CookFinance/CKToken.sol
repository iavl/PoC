// https://bscscan.com/address/0xA4e9f6032ee717710D8Fd3dCE0367d283e16f50e
...
// File @openzeppelin/contracts/utils/SafeCast.sol@v3.4.1
...
// File @openzeppelin/contracts/math/SignedSafeMath.sol@v3.4.1
...
contract CKToken is ERC20 {
    ...
    */
    ...
    function _validateOnlyModule() internal view {
        require(moduleStates[msg.sender] == ICKToken.ModuleState.INITIALIZED, "Only the module can call");
...
contract CKTokenCreator {
    ...
    function create(
        ...
        CKToken ckToken = new CKToken(_components, _units, _modules, controller, _manager, _name, _symbol);
